...
class GeneratedLocalization {
  ...
  /// `Неизвестная ошибка: {value}`
  String unknownError(Object value) {
    return Intl.message(
      'Неизвестная ошибка: $value',
      name: 'unknownError',
      desc: '',
  ...
  /// `Возникло исключение: {value}`
  String exceptionOccurred(Object value) {
    return Intl.message(
      'Возникло исключение: $value',
